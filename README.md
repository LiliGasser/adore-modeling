...
[ADORE](https://github.com/LiliGasser/adore) is a benchmark dataset for modeling acute mortality in fish, crustaceans, and algae. This repository shows how to model the challenges (i.e., data subsets) of ADORE.
...
This repository contains the benchmark datasets, imported from the [data repository](https://github.com/LiliGasser/adore), and scripts to view the data and to model the 't-F2F' challenge with random forests. 
...
```
git clone git@github.com:LiliGasser/adore-modeling.git 
cd adore-modeling/
```
...
For other models and more detailed evaluations, check the modeling repository [mltox-model](https://github.com/LiliGasser/mltox-model).
